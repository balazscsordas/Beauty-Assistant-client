    ...
    return (
        <section className="flex justify-center items-center min-h-50vh bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-sky-600 to-indigo-900">
            <div className="text-center text-white">
                ...
                <p className="font-medium">{lang === 'hun' ? 'Időpontkezelés, vendég nyilvántartás gyorsan, egyszerűen, hatékonyan.' : 'Fast and effective solution for appointment management.'}</p>
