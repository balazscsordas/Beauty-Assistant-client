        ...
        <>
            <section className="flex flex-col lg:flex-row">
                <div className="flex-1 mx-2">
                    <OneLineReqInput onChange={handleChange} value={inputData.name} label="Név" nameVal="name"/>
                </div>
                <div className="flex-1 mx-2">
                    {inputData.category === 'Új kategória hozzáadása' || categoryList.length === 1
                        ...
                        : <BasicSelectInputField label="Kategória" value={inputData.category} array={categoryList} onChange={handleSelectChange} nameVal="category"/>
                    }
                </div>
                <div className="flex-1 mx-2">
                    <OneLineReqInput onChange={handleChange} value={inputData.price === 0 ? "" : inputData.price} label="Ár (Ft)" nameVal="price" showError={showPriceError} errorText="Kizárólag számot tartalmazhat!"/>
                </div>
                <div className="flex-1 mx-2">
                    <BasicSelectInputField label="Időtartam (perc)" value={inputData.time === 0 ? "" : inputData.time} array={timeOptions} onChange={handleSelectChange} nameVal="time"/>
                </div>
            </section>
            <div>
